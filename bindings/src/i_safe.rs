...
pub mod ISafe {
    ...
    ///Container type for the return parameters of the [`checkNSignatures(address,bytes32,bytes,uint256)`](checkNSignaturesCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    ///Container type for the return parameters of the [`checkSignatures(address,bytes32,bytes)`](checkSignaturesCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    impl alloy_sol_types::SolInterface for ISafeCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ISafeCalls>] = &[
                {
                    fn addOwnerWithThreshold(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <addOwnerWithThresholdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            data,
                        )
                        .map(ISafeCalls::addOwnerWithThreshold)
                    }
                    addOwnerWithThreshold
                },
                {
                    fn checkNSignatures(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <checkNSignaturesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::checkNSignatures)
                    }
                    checkNSignatures
                },
                {
                    fn isModuleEnabled(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <isModuleEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::isModuleEnabled)
                    }
                    isModuleEnabled
                },
                {
                    fn isOwner(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <isOwnerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::isOwner)
                    }
                    isOwner
                },
                {
                    fn execTransactionFromModule(
                        ...
                        .map(ISafeCalls::execTransactionFromModule)
                    }
                ...
                },
                {
                    fn execTransactionFromModuleReturnData(
                        ...
                        <execTransactionFromModuleReturnDataCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISafeCalls::execTransactionFromModuleReturnData)
                    }
                    execTransactionFromModuleReturnData
                },
                {
                    fn getStorageAt(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <getStorageAtCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::getStorageAt)
                    }
                    getStorageAt
                },
                {
                    fn signedMessages(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <signedMessagesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::signedMessages)
                    }
                    signedMessages
                },
                {
                    fn enableModule(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <enableModuleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::enableModule)
                    }
                    enableModule
                },
                {
                    fn changeThreshold(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <changeThresholdCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::changeThreshold)
                    }
                    changeThreshold
                },
                {
                    fn execTransaction(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                ...
                {
                    fn approvedHashes(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <approvedHashesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::approvedHashes)
                    }
                    approvedHashes
                },
                {
                    fn getOwners(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <getOwnersCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::getOwners)
                    }
                    getOwners
                },
                {
                    fn nonce(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <nonceCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::nonce)
                    }
                    nonce
                },
                {
                    fn simulateAndRevert(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <simulateAndRevertCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::simulateAndRevert)
                    }
                    simulateAndRevert
                },
                {
                    fn setup(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <setupCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::setup)
                    }
                    setup
                },
                {
                    fn getModulesPaginated(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <getModulesPaginatedCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::getModulesPaginated)
                    }
                    getModulesPaginated
                },
                {
                    fn approveHash(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <approveHashCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::approveHash)
                    }
                    approveHash
                },
                {
                    fn getTransactionHash(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <getTransactionHashCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::getTransactionHash)
                    }
                    getTransactionHash
                },
                {
                    fn disableModule(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <disableModuleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::disableModule)
                    }
                    disableModule
                },
                {
                    fn setModuleGuard(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <setModuleGuardCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::setModuleGuard)
                    }
                    setModuleGuard
                },
                {
                    fn setGuard(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <setGuardCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::setGuard)
                    }
                    setGuard
                },
                {
                    fn swapOwner(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <swapOwnerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::swapOwner)
                    }
                    swapOwner
                },
                {
                    fn getThreshold(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <getThresholdCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::getThreshold)
                    }
                    getThreshold
                },
                {
                    fn setFallbackHandler(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <setFallbackHandlerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::setFallbackHandler)
                    }
                    setFallbackHandler
                },
                {
                    fn domainSeparator(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <domainSeparatorCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::domainSeparator)
                    }
                    domainSeparator
                },
                {
                    fn checkSignatures(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <checkSignaturesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::checkSignatures)
                    }
                    checkSignatures
                },
                {
                    fn removeOwner(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <removeOwnerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::removeOwner)
                    }
                    removeOwner
                },
                {
                    fn VERSION(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
                        <VERSIONCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ISafeCalls::VERSION)
                    }
                    VERSION
                },
            ];
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ISafeCalls>] = &[
                {
                    fn addOwnerWithThreshold(data: &[u8]) -> alloy_sol_types::Result<ISafeCalls> {
    ...
    ///Container for all the [`ISafe`](self) events.
    #[derive(serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq, Hash)]
    pub enum ISafeEvents {
        #[allow(missing_docs)]
    ...
    impl alloy_sol_types::SolEventInterface for ISafeEvents {
        const NAME: &'static str = "ISafeEvents";
    ...
    impl alloy_sol_types::private::IntoLogData for ISafeEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    >(
        ...
        ISafeInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ISafeInstance<P, N>>> {
        ISafeInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        ISafeInstance::<P, N>::deploy_builder(provider)
    }
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ISafeInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for ISafeInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ISafeInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<ISafeInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> ISafeInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISafeInstance<P, N> {
            ISafeInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
        ...
        ISafeInstance<P, N>
    {
        ...
        pub fn approvedHashes(
            ...
            self.call_builder(&approvedHashesCall { owner, messageHash })
        }
        ...
        pub fn signedMessages(
            ...
            self.call_builder(&signedMessagesCall { messageHash })
        }

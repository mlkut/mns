...
interface BaseTransactionGuard {
...
pub mod BaseTransactionGuard {
    ...
    ///Container for all the [`BaseTransactionGuard`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum BaseTransactionGuardCalls {
        #[allow(missing_docs)]
    ...
    impl BaseTransactionGuardCalls {
    ...
    impl alloy_sol_types::SolInterface for BaseTransactionGuardCalls {
        const NAME: &'static str = "BaseTransactionGuardCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<BaseTransactionGuardCalls>] = &[
                {
                    fn supportsInterface(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<BaseTransactionGuardCalls> {
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseTransactionGuardCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn checkTransaction(
                        ...
                        <checkTransactionCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseTransactionGuardCalls::checkTransaction)
                    }
                    checkTransaction
                },
                {
                    fn checkAfterExecution(
                        ...
                        <checkAfterExecutionCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseTransactionGuardCalls::checkAfterExecution)
                    }
                    checkAfterExecution
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`BaseTransactionGuard`](self) contract instance.

    See the [wrapper's documentation](`BaseTransactionGuardInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> BaseTransactionGuardInstance<P, N> {
        BaseTransactionGuardInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<BaseTransactionGuardInstance<P, N>>>
    {
        BaseTransactionGuardInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        BaseTransactionGuardInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`BaseTransactionGuard`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`BaseTransactionGuard`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BaseTransactionGuardInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for BaseTransactionGuardInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BaseTransactionGuardInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        BaseTransactionGuardInstance<P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<BaseTransactionGuardInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> BaseTransactionGuardInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BaseTransactionGuardInstance<P, N> {
            BaseTransactionGuardInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
        ...
        BaseTransactionGuardInstance<P, N>
    {
        ...
        pub fn checkAfterExecution(
            ...
            self.call_builder(&checkAfterExecutionCall { hash, success })
        }

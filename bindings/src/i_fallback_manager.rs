...
pub mod IFallbackManager {
    ...
    ///Container for all the [`IFallbackManager`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum IFallbackManagerCalls {
        #[allow(missing_docs)]
        setFallbackHandler(setFallbackHandlerCall),
    }
    impl IFallbackManagerCalls {
    ...
    impl alloy_sol_types::SolInterface for IFallbackManagerCalls {
        const NAME: &'static str = "IFallbackManagerCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IFallbackManagerCalls>] =
                &[{
                    fn setFallbackHandler(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IFallbackManagerCalls> {
                        <setFallbackHandlerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IFallbackManagerCalls::setFallbackHandler)
                    }
                    setFallbackHandler
                }];
    ...
    ///Container for all the [`IFallbackManager`](self) events.
    #[derive(serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq, Hash)]
    pub enum IFallbackManagerEvents {
        #[allow(missing_docs)]
        ChangedFallbackHandler(ChangedFallbackHandler),
    }
    impl IFallbackManagerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    impl alloy_sol_types::SolEventInterface for IFallbackManagerEvents {
        const NAME: &'static str = "IFallbackManagerEvents";
        const COUNT: usize = 1usize;
        fn decode_raw_log(
    ...
    impl alloy_sol_types::private::IntoLogData for IFallbackManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IFallbackManager`](self) contract instance.

    See the [wrapper's documentation](`IFallbackManagerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IFallbackManagerInstance<P, N> {
        IFallbackManagerInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IFallbackManagerInstance<P, N>>>
    {
        IFallbackManagerInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IFallbackManagerInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IFallbackManager`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IFallbackManager`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IFallbackManagerInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for IFallbackManagerInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IFallbackManagerInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IFallbackManagerInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IFallbackManagerInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IFallbackManagerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IFallbackManagerInstance<P, N> {
            IFallbackManagerInstance {

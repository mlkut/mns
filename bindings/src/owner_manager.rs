...
pub mod OwnerManager {
    ...
    impl alloy_sol_types::SolInterface for OwnerManagerCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<OwnerManagerCalls>] = &[
                {
                ...
                {
                    fn isOwner(data: &[u8]) -> alloy_sol_types::Result<OwnerManagerCalls> {
                ...
                {
                    fn changeThreshold(data: &[u8]) -> alloy_sol_types::Result<OwnerManagerCalls> {
                ...
                {
                    fn getOwners(data: &[u8]) -> alloy_sol_types::Result<OwnerManagerCalls> {
                ...
                {
                    fn swapOwner(data: &[u8]) -> alloy_sol_types::Result<OwnerManagerCalls> {
                ...
                {
                    fn getThreshold(data: &[u8]) -> alloy_sol_types::Result<OwnerManagerCalls> {
                ...
                {
                    fn removeOwner(data: &[u8]) -> alloy_sol_types::Result<OwnerManagerCalls> {
    ...
    >(
        ...
        OwnerManagerInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<OwnerManagerInstance<P, N>>>
    {
        OwnerManagerInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        OwnerManagerInstance::<P, N>::deploy_builder(provider)
    }
    ...
    impl<P, N> ::core::fmt::Debug for OwnerManagerInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("OwnerManagerInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        OwnerManagerInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<OwnerManagerInstance<P, N>> {

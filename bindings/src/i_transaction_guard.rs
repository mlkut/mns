...
pub mod ITransactionGuard {
    ...
    ///Container for all the [`ITransactionGuard`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum ITransactionGuardCalls {
        #[allow(missing_docs)]
    ...
    impl alloy_sol_types::SolInterface for ITransactionGuardCalls {
        const NAME: &'static str = "ITransactionGuardCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ITransactionGuardCalls>] =
                &[
                    {
                        fn supportsInterface(
                            data: &[u8],
                        ) -> alloy_sol_types::Result<ITransactionGuardCalls>
                        {
                            <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                            .map(ITransactionGuardCalls::supportsInterface)
                        }
                        supportsInterface
                    },
                    {
                        ...
                        ) -> alloy_sol_types::Result<ITransactionGuardCalls>
                        {
                            <checkTransactionCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                                .map(ITransactionGuardCalls::checkTransaction)
                        }
                        checkTransaction
                    },
                    {
                        ...
                        ) -> alloy_sol_types::Result<ITransactionGuardCalls>
                        {
                            ...
                            .map(ITransactionGuardCalls::checkAfterExecution)
                        }
                        checkAfterExecution
                    },
                ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ITransactionGuard`](self) contract instance.

    See the [wrapper's documentation](`ITransactionGuardInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ITransactionGuardInstance<P, N> {
        ITransactionGuardInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ITransactionGuardInstance<P, N>>>
    {
        ITransactionGuardInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        ITransactionGuardInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`ITransactionGuard`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`ITransactionGuard`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ITransactionGuardInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for ITransactionGuardInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ITransactionGuardInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        ITransactionGuardInstance<P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ITransactionGuardInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> ITransactionGuardInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ITransactionGuardInstance<P, N> {
            ITransactionGuardInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }

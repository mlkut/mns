...
pub mod BaseModuleGuard {
    ...
    ///Container for all the [`BaseModuleGuard`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum BaseModuleGuardCalls {
        #[allow(missing_docs)]
    ...
    impl alloy_sol_types::SolInterface for BaseModuleGuardCalls {
        const NAME: &'static str = "BaseModuleGuardCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<BaseModuleGuardCalls>] = &[
                {
                    fn supportsInterface(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<BaseModuleGuardCalls> {
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseModuleGuardCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn checkAfterModuleExecution(
                        ...
                        .map(BaseModuleGuardCalls::checkAfterModuleExecution)
                    }
                ...
                },
                {
                    fn checkModuleTransaction(
                        ...
                        .map(BaseModuleGuardCalls::checkModuleTransaction)
                    }
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`BaseModuleGuard`](self) contract instance.

    See the [wrapper's documentation](`BaseModuleGuardInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> BaseModuleGuardInstance<P, N> {
        BaseModuleGuardInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<BaseModuleGuardInstance<P, N>>>
    {
        BaseModuleGuardInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        BaseModuleGuardInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`BaseModuleGuard`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`BaseModuleGuard`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BaseModuleGuardInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for BaseModuleGuardInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BaseModuleGuardInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        BaseModuleGuardInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<BaseModuleGuardInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> BaseModuleGuardInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BaseModuleGuardInstance<P, N> {
            BaseModuleGuardInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }

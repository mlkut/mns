...
pub mod IGuardManager {
    ...
    ///Container for all the [`IGuardManager`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum IGuardManagerCalls {
        #[allow(missing_docs)]
        setGuard(setGuardCall),
    }
    impl IGuardManagerCalls {
    ...
    impl alloy_sol_types::SolInterface for IGuardManagerCalls {
        const NAME: &'static str = "IGuardManagerCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IGuardManagerCalls>] = &[{
                fn setGuard(data: &[u8]) -> alloy_sol_types::Result<IGuardManagerCalls> {
                    <setGuardCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                        .map(IGuardManagerCalls::setGuard)
                }
                setGuard
            }];
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IGuardManagerCalls>] = &[{
                fn setGuard(data: &[u8]) -> alloy_sol_types::Result<IGuardManagerCalls> {
    ...
    ///Container for all the [`IGuardManager`](self) events.
    #[derive(serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq, Hash)]
    pub enum IGuardManagerEvents {
        #[allow(missing_docs)]
        ChangedGuard(ChangedGuard),
    }
    impl IGuardManagerEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    impl alloy_sol_types::SolEventInterface for IGuardManagerEvents {
        const NAME: &'static str = "IGuardManagerEvents";
        const COUNT: usize = 1usize;
        fn decode_raw_log(
    ...
    impl alloy_sol_types::private::IntoLogData for IGuardManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IGuardManager`](self) contract instance.

    See the [wrapper's documentation](`IGuardManagerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IGuardManagerInstance<P, N> {
        IGuardManagerInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IGuardManagerInstance<P, N>>>
    {
        IGuardManagerInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IGuardManagerInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IGuardManager`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IGuardManager`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IGuardManagerInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for IGuardManagerInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IGuardManagerInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IGuardManagerInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IGuardManagerInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IGuardManagerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IGuardManagerInstance<P, N> {
            IGuardManagerInstance {

...
pub mod IModuleManager {
    ...
    ///Container for all the [`IModuleManager`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum IModuleManagerCalls {
        #[allow(missing_docs)]
    ...
    impl alloy_sol_types::SolInterface for IModuleManagerCalls {
        const NAME: &'static str = "IModuleManagerCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IModuleManagerCalls>] = &[
                {
                    fn isModuleEnabled(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IModuleManagerCalls> {
                        <isModuleEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IModuleManagerCalls::isModuleEnabled)
                    }
                    isModuleEnabled
                },
                {
                    fn execTransactionFromModule(
                        ...
                        .map(IModuleManagerCalls::execTransactionFromModule)
                    }
                ...
                },
                {
                    fn execTransactionFromModuleReturnData(
                        ...
                        <execTransactionFromModuleReturnDataCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IModuleManagerCalls::execTransactionFromModuleReturnData,
                            )
                    }
                    execTransactionFromModuleReturnData
                },
                {
                    fn enableModule(data: &[u8]) -> alloy_sol_types::Result<IModuleManagerCalls> {
                        <enableModuleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IModuleManagerCalls::enableModule)
                    }
                    enableModule
                },
                {
                    fn getModulesPaginated(
                        ...
                        <getModulesPaginatedCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IModuleManagerCalls::getModulesPaginated)
                    }
                    getModulesPaginated
                },
                {
                    fn disableModule(data: &[u8]) -> alloy_sol_types::Result<IModuleManagerCalls> {
                        <disableModuleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IModuleManagerCalls::disableModule)
                    }
                    disableModule
                },
                {
                    fn setModuleGuard(data: &[u8]) -> alloy_sol_types::Result<IModuleManagerCalls> {
                        <setModuleGuardCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IModuleManagerCalls::setModuleGuard)
                    }
                    setModuleGuard
                },
            ];
    ...
    ///Container for all the [`IModuleManager`](self) events.
    #[derive(serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq, Hash)]
    pub enum IModuleManagerEvents {
        #[allow(missing_docs)]
    ...
    impl alloy_sol_types::SolEventInterface for IModuleManagerEvents {
        const NAME: &'static str = "IModuleManagerEvents";
    ...
    impl alloy_sol_types::private::IntoLogData for IModuleManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IModuleManager`](self) contract instance.

    See the [wrapper's documentation](`IModuleManagerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IModuleManagerInstance<P, N> {
        IModuleManagerInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IModuleManagerInstance<P, N>>>
    {
        IModuleManagerInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IModuleManagerInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IModuleManager`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IModuleManager`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IModuleManagerInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for IModuleManagerInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IModuleManagerInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IModuleManagerInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IModuleManagerInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IModuleManagerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IModuleManagerInstance<P, N> {
            IModuleManagerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }

...
pub mod IStorageAccessible {
    ...
    ///Container for all the [`IStorageAccessible`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum IStorageAccessibleCalls {
        #[allow(missing_docs)]
        getStorageAt(getStorageAtCall),
        #[allow(missing_docs)]
        simulateAndRevert(simulateAndRevertCall),
    }
    impl IStorageAccessibleCalls {
    ...
    impl alloy_sol_types::SolInterface for IStorageAccessibleCalls {
        const NAME: &'static str = "IStorageAccessibleCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IStorageAccessibleCalls>] = &[
                {
                    fn getStorageAt(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IStorageAccessibleCalls> {
                        <getStorageAtCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IStorageAccessibleCalls::getStorageAt)
                    }
                    getStorageAt
                },
                {
                    fn simulateAndRevert(
                        ...
                        <simulateAndRevertCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IStorageAccessibleCalls::simulateAndRevert)
                    }
                    simulateAndRevert
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IStorageAccessible`](self) contract instance.

    See the [wrapper's documentation](`IStorageAccessibleInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IStorageAccessibleInstance<P, N> {
        IStorageAccessibleInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IStorageAccessibleInstance<P, N>>>
    {
        IStorageAccessibleInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IStorageAccessibleInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IStorageAccessible`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IStorageAccessible`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IStorageAccessibleInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    impl<P, N> ::core::fmt::Debug for IStorageAccessibleInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IStorageAccessibleInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IStorageAccessibleInstance<P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IStorageAccessibleInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IStorageAccessibleInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IStorageAccessibleInstance<P, N> {
            IStorageAccessibleInstance {
